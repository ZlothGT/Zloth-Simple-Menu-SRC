...
namespace StupidTemplate.Menu
{
    ...
    public class Main : MonoBehaviour
    {
        ...
        public static void CreateMenu()
        {
            ...
            // Buttons
                // Disconnect
                    if (disconnectButton)
                    {
                        ...
                        disconnectbutton.transform.localPosition = new Vector3(0.56f, 0f, 0.7f);
                        disconnectbutton.GetComponent<Renderer>().material.color = Color.red;
                        ...
                        rectt.localPosition = new Vector3(0.064f, 0f, 0.27f);
                        rectt.rotation = Quaternion.Euler(new Vector3(180f, 90f, 90f));
                    }
            //Join Random Button
            GameObject joinbutton = GameObject.CreatePrimitive(PrimitiveType.Cube);
            if (!UnityInput.Current.GetKey(KeyCode.Q))
            {
                joinbutton.layer = 2;
            }
            UnityEngine.Object.Destroy(joinbutton.GetComponent<Rigidbody>());
            joinbutton.GetComponent<BoxCollider>().isTrigger = true;
            joinbutton.transform.parent = menu.transform;
            joinbutton.transform.rotation = Quaternion.identity;
            joinbutton.transform.localScale = new Vector3(0.09f, 0.4f, 0.13f);
            joinbutton.transform.localPosition = new Vector3(0.56f, 0f, 0.58f);
            joinbutton.GetComponent<Renderer>().material.color = Color.green;
            joinbutton.AddComponent<Classes.Button>().relatedText = "Join Random";
            ...
            discontext1.text = "Join Random";
            discontext1.font = currentFont;
            discontext1.fontSize = 1;
            discontext1.color = Color.red;
            ...
            rectt1.localPosition = new Vector3(0.064f, 0f, 0.22f);
            ...
            GameObject gameObject = GameObject.CreatePrimitive(PrimitiveType.Cube);
                    ...
                    gameObject.transform.localScale = new Vector3(0.09f, 0.4f, 0.13f);
                    gameObject.transform.localPosition = new Vector3(0.56f, 0.4f, 0.58f);
                    ...
                    component.localPosition = new Vector3(0.064f, 0.13f, 0.225f);
                    component.rotation = Quaternion.Euler(new Vector3(180f, 90f, 90f));
            ...
            text.font = currentFont;
            text.text = "Zloth Menu - Ver 1.0.1";
            text.fontSize = 1;
            ...
            component.localPosition = Vector3.zero;
            component.sizeDelta = new Vector2(0.2f, 0.03f);
            component.localPosition = new Vector3(0.043f, 0, 0.16f);
